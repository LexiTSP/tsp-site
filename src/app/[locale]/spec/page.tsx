...
export default async function SpecPage({
  ...
  const CHANGES_NO = [
    { version: "3.0.0-alpha.4", date: "2026-04-30", notes: "Alignment-schema bump + riskSink. 101 SDK-tester. Launch-ready bundle (alpha).", current: true },
  ...
  const CHANGES_EN = [
    { version: "3.0.0-alpha.4", date: "2026-04-30", notes: "Alignment-schema bump + riskSink. 101 SDK tests. Launch-ready bundle (alpha).", current: true },
