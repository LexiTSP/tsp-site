...
const ENTRIES_NO: Entry[] = [
  {
    ...
    changes: [
      ...
      { tag: "feature", text: "@lexitsp/sdk@3.0.0-alpha.4 (101 tester, TS strict)" },
      { tag: "feature", text: "@lexitsp/trustbadge-react@0.2.0 — visuell kvittering for sluttbruker" },
...
const ENTRIES_EN: Entry[] = [
  {
    ...
    changes: [
      ...
      { tag: "feature", text: "@lexitsp/sdk@3.0.0-alpha.4 (101 tests, TS strict)" },
      { tag: "feature", text: "@lexitsp/trustbadge-react@0.2.0 — visual receipt for end users" },
