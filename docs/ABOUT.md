...
|---|---|---|---|
| `@lexitsp/sdk` (Protokoll v3) | 3.0.0-alpha.6 | 101 | Phase 1+2+3 + I-pluss komplett |
| `@lexitsp/trustbadge-react` | 0.2.2 | 24 | MIT, publish-klar |
...
| Site (truststandardprotocol.com) | — | build grønn | 55 statiske sider, charter §6 ren |
